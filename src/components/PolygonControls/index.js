...
import { getHorizontallyCentralPoint, getVerticallyLowestPoint, getVerticallyCentralPoint } from '../../utils/pointsUtils'
  ...
  return (
    <div
      style={{
        ...
        top: `${(getVerticallyCentralPoint(geometry.points) + ((10 * (1 / 5)) + (10 * (4 / 5) * zoomBetweenZeroAndOne)))}%`,
        zIndex:999999,
        ...props.style
      }}
    >
